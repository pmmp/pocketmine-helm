...
type FakePlugins struct {
	Fake *FakePmmpV1alpha1
	ns   string
}

var pluginsResource = schema.GroupVersionResource{Group: "pmmp.io", Version: "v1alpha1", Resource: "plugins"}

var pluginsKind = schema.GroupVersionKind{Group: "pmmp.io", Version: "v1alpha1", Kind: "Plugin"}
