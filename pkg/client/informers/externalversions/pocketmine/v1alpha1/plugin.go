...
import (
	...
	versioned "github.com/pmmp/pocketmine-helm/pkg/client/clientset/versioned"
	internalinterfaces "github.com/pmmp/pocketmine-helm/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/pmmp/pocketmine-helm/pkg/client/listers/pocketmine/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PmmpV1alpha1().Plugins(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PmmpV1alpha1().Plugins(namespace).Watch(context.TODO(), options)
			},
		},
		&pocketminev1alpha1.Plugin{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pluginInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pocketminev1alpha1.Plugin{}, f.defaultInformer)
}
